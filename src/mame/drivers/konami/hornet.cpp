...
Notes:
  ...
  M48T58Y-70PC1 - ST Timekeeper M48T58Y-70PC1 Non-volatile RAM module.
                  ...
                  Note that not all EPROM programmers can correctly write these RTC chips and in some cases when
                  trying to read a working RTC it will corrupt the data and make it unusable, thus killing your
                  game. So be very careful when dealing with these chips and be sure your equipment fully supports
                  it before trying to read a rare undumped chip. When in doubt try reading/writing a spare RTC that
